...
export default class Cursor<TRecord> extends ReadableStream implements Promise<Array<TRecord>> {
     ...
     */
    then<TResult1 = Array<TRecord>, TResult2 = never>(onfulfilled?: ((value: Array<TRecord>) => TResult1 | PromiseLike<TResult1>) | undefined | null, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | undefined | null): Promise<TResult1 | TResult2>;
    /**
     * Attaches a callback for only the rejection of the ThenPromise.
     * @param onrejected The callback to execute when the ThenPromise is rejected.
     * @returns A ThenPromise for the completion of the callback.
     */
    catch<TResult = never>(onrejected?: ((reason: any) => TResult | PromiseLike<TResult>) | undefined | null): Promise<Array<TRecord> | TResult>;
    /**
     * Attaches callbacks for the resolution and/or rejection of the ThenPromise, without returning a new promise.
     * @param onfulfilled The callback to execute when the ThenPromise is resolved.
     * @param onrejected The callback to execute when the ThenPromise is rejected.
     */
    done(onfulfilled?: ((value: Array<TRecord>) => any) | undefined | null, onrejected?: ((reason: any) => any) | undefined | null): void;
    /**
